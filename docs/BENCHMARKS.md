...
Runtime: **60–61 fps** during playback; worker frame decode 2.5–7.7 ms;
worker depth sort (16-bit counting sort) 3–25 ms, triggered only on view
rotation or frame change; per-frame GPU upload ~8 MB (positions + packed
quaternions + packed RGBA).
